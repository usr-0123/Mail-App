...
const PostContent = ({ userDetails, actions }) => {
  return (
    <div className="post-content-container">
      ...
      <span>
        Here are some photography works that I made on the weekend with some of
        my friends
      </span>
      <div className="photo-div">
        <img id="photo-1" src={dp} alt="noImg" />
        <img src={content} alt="noImg" />
      </div>
